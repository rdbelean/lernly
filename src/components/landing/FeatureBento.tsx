 ...
 *
 * Strict design system (do not improvise):
 *  - Background #0F1322, card surfaces #141930 / #171C30, borders white/7%.
 *  - ONE accent: deep indigo #2B3499 (+ lighter #4B57D6 for gradients/labels).
 *    Monochrome indigo-on-dark — no rainbow cards, no green/orange.
 *  - Sora (font-display) for headings, Inter (font-sans) for body.
 *  - 2x2 grid on desktop, single column on mobile. Card 2 is the hero
 *    (stronger indigo glow + brighter border).
 *  - Mockups are the selling point — real, polished product UI, no emojis.
 */
...
export default function FeatureBento() {
  return (
    ...
    >
      {/* Restrained indigo glow behind the hero card */}
      <div
        aria-hidden
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundColor: "#0F1322", borderColor: "rgba(255,255,255,0.07)" }}
      >
        {/* File row */}
        <div
        ...
        >
          ...
          <span className="truncate font-sans text-[13px] font-medium text-white/85">
            Vorlesung_BWL.pdf
          </span>
          <span
            className="ml-auto font-sans text-[12px]"
            style={{ color: "#6B7290" }}
          >
            4.2 MB
          </span>
        ...
        >
          <div
            ...
            style={{ width: "70%", background: INDIGO_GRAD }}
          />
        </div>
...
function Pill({ children }: { children: ReactNode }) {
  return (
    <span
      className="inline-flex items-center rounded-full border px-2.5 py-1 font-sans text-[12px] font-medium text-white/75"
      style={{
        backgroundColor: "rgba(255,255,255,0.03)",
...
/* ------------------------------------------------------------------ */
/* Card 2 — Quiz / exam simulator (HERO)                               */
/* ------------------------------------------------------------------ */
...
function QuizCard() {
  ...
  return (
    <>
      ...
      <div
        className="mt-auto rounded-2xl border p-4"
        style={{ backgroundColor: "#0F1322", borderColor: "rgba(75,87,214,0.25)" }}
      >
        <span
...
function PhoneMock() {
  return (
    <div
      className="w-[208px] rounded-[28px] border p-2.5"
      style={{
    ...
    >
      <div
        ...
        style={{ backgroundColor: "#0F1322", borderColor: "rgba(255,255,255,0.06)" }}
      >
        {/* Status bar */}
        ...
        <div className="px-3.5 pb-5 pt-1">
          ...
          <div
            className="mt-2 rounded-2xl border px-3.5 py-5"
            style={{
              backgroundColor: "rgba(255,255,255,0.03)",
              borderColor: "rgba(255,255,255,0.08)",
            }}
          ...
          <div
            className="mt-3 rounded-xl py-2.5 text-center font-sans text-[12px] font-semibold text-white"
          ...
          {rows.map((r) => (
            <div key={r.label}>
              ...
              >
                <div
                  className="h-full rounded-full"
                  style={{ width: `${r.pct}%`, background: INDIGO_GRAD }}
                />
              </div>
            </div>
          ))}
