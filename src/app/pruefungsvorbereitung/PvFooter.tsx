...
// Light footer for the /pruefungsvorbereitung B2B route. Mirrors HsFooter
// (LinkedIn + legal, no student TikTok) with the ICP-specific label.
export default function PvFooter() {
  return (
      ...
      <div className="mx-auto max-w-[1140px]">
        ...
        <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
          ...
          >
            ...
            <Link href="/hochschulen" className="transition hover:text-[color:var(--hs-ink)]">
              Für Hochschulen
            </Link>
          </div>
